...
public class CertHashCheckerTest {
    ...
    private static AndroidApkSignerVerify.Result getVerifyResult(String... shas256) {
        ...
        return new AndroidApkSignerVerify.Result(true, null, null, null, true, true, certInfos);
    }
}
