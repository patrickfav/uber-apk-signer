...
public class CLIParserTest {
    ...
    public void testSimpleWithOnlyApkFile() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, false, false, false, false, false, false, null);
    ...
    public void testWithKeystore() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, "my-keystore.jks", null, null, null, false, false, false, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithKeystoreAndAlias() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, "my-keystore.jks", null, null, "debugAlias", false, false, false, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithKeystoreAndAliasAndPws() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, "my-keystore.jks", "secret", "secret2", "debugAlias", false, false, false, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithOnlyVerify() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, false, false, false, false, false, true, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithDebug() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, false, false, false, false, true, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithSkipZipAlign() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, false, false, false, true, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithOverwrite() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, true, false, false, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithDryRun() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, false, true, false, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithVerbose() throws Exception {
        ...
        Arg expectedArg = new Arg("./", false, null, null, null, null, false, false, true, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
