...
public class CLIParserTest {
    ...
    public void testSimpleWithOnlyApkFile() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, false, false, false, false, false, null, false, false);
    ...
    public void testWithOut() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, "./test", Collections.emptyList(), false, false, false, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithKeystoreAndAlias() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.singletonList(new Arg.SignArgs(0, "my-keystore.jks", "debugAlias", null, null)), false, false, false, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithDebugKeystore() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.singletonList(new Arg.SignArgs(0, "my-debug-keystore.jks", null, null, null)), false, false, false, false, false, false, null, true, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithKeystoreAndAliasAndPws() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.singletonList(new Arg.SignArgs(0, "my-keystore.jks", "debugAlias", "secret", "secret2")), false, false, false, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithOnlyVerify() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, false, false, false, false, true, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithDebug() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, false, false, false, true, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithSkipZipAlign() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, false, false, true, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithOverwrite() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), true, false, false, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithDryRun() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, true, false, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithVerbose() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, false, true, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWithAllowResign() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./"}, null, Collections.emptyList(), false, false, false, false, false, false, null, false, true);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testMultipleFiles() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"./", "apk1.apk", "apk2.apk"}, null, Collections.emptyList(), false, false, false, false, false, false, null, false, false);
        assertEquals(expectedArg, parsedArg);
    }
